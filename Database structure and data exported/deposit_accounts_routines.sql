...
--
-- Dumping routines for database 'deposit_accounts'
--
/*!50003 DROP PROCEDURE IF EXISTS `getcurrentaccounts` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getcurrentaccounts`()
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS `getsavingaccounts` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getsavingaccounts`()
BEGIN
